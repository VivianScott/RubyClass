...
vocab["next"]="this makes a integer go up one, you use it like 5.pred would be 6"
vocab["strings"]="this"
vocab["comments"]="=begin comment =end"
vocab["terminal"]="A program that allows the user to give commands to the computer"
vocab["operators"]="+,-,=,*,/"
vocab["booleans"]="true or false"
vocab["reverse"]="reverae.reverse = esrever"
vocab["length"]="word.length shows the length of the word"
vocab["upcase"]="MAKES STUFF IN CAPS"
vocab["downcase"]="makes stuff lower case"
vocab["Hash"]="makes an object"
